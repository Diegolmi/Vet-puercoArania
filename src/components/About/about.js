            ...
            <section className="col-main col-sm-12">
              ...
              <h1 className="first-title">Acerca de Veterinaria Puerco Araña</h1>
                <div className="medicos">
                  <div className="bmedicos">
                    <Image
                      ...
                      alt=""
                    />
                    <p className="datosmedicos">Liliana Luna</p>
                    <p className="datosmedicos1">Cirugia</p>
                  </div>
                  <div className="bmedicos">
                    <Image
                      src={medico2}
                      ...
                      alt=""
                    />
                    <p className="datosmedicos">Carlos Paez </p>
                    <p className="datosmedicos1">Oftalmologia</p>
                  </div>
                  <div className="bmedicos">
                    <Image
                      src={medico3}
                      ...
                      alt=""
                    />
                    <p className="datosmedicos">Marta Cisneros </p>
                    <p className="datosmedicos1">Cardiolgia</p>
                  </div>
                  <div className="bmedicos">
                    <Image
                      src={medico4}
                      ...
                      alt=""
                    />
                    <p className="datosmedicos"> Rafael Puentes </p>
                    <p className="datosmedicos1">Fiosioterapia</p>
                  </div>
                </div>
                ...
                <h3 className="third-title">Historia de la empresa</h3>
                  ...
                  <p className="paragraph">
                    Dos años más se establecieron con un local en General Paz 576

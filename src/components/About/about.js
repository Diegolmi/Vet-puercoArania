      ...
      <div className="institucional container-fluid">
        ...
        <div className="static-contain">
          ...
          <Typography variant="body1" className="paragraph">
            ...
            inspiraron su nombre en el dibujo animado de los Simpson, sugerido
            por Erika, hija de Carlos Lopez y Graciela Correa.
          </Typography>
          <Typography variant="body1" className="paragraph">
          ...
          <Typography variant="body1" className="paragraph">
            ...
            conseguían de la industria local. Fue tan impactante que comezaron
            con importación, venta y distribución de accesorios dando origen a
            la empresa Puerco's.
          </Typography>
          <Typography variant="body1" className="paragraph">
            ...
            propios que hoy cuentan con 9 locales distribuidos en la Provincia
            de Tucumán.
          </Typography>
          ...
          <Typography variant="body1" className="paragraph">
            ...
            comerciales que flexibilizan las operaciones comerciales diarias.
            Con entregas semanales podemos hacer transferencias de mercaderías
            entre los puntos de venta prestando artículos entre cada una de las
            unidades perdiendo muy pocas ventas por escasez de producto.
          </Typography>
          <Typography variant="h4" className="fourd-title">
            Tecnología
          </Typography>
          ...
          <Typography variant="body1" className="paragraph">
            ...
            argentino. Nuestra pasión por las novedades y búsqueda contante de
            nuevas formas de llegar al consumidor nos aseguran un lugar en el
            futuro entre los jugadores importantes del mercado.
          </Typography>
          <Typography variant="h4" className="fourd-title">
          ...
          <Typography variant="body1" className="paragraph">
            ...
            cualquier otra empresa del rubro.Todas estas razones son muy
            importantes y seguramente son razones tangibles, pero la más
            importante es un intangible, una realidad paralela, una sensación…y
            es el factor humano. La gente comprometida en el proyecto desde
            quienes dimos el primer paso a quienes se van sumando es nuestro
            diferencial… gente que se equivoca, que trabaja, que se frustra
            cuando las cosas no salen de la manera esperada…. gente que HACE.
          </Typography>
        </div>
      </div>
    </>

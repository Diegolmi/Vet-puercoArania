        ...
        <MDBCol className="contenido2 d-flex">
          <div className="texto2">
            ...
            <MDBTypography abbr="false">
              ...
              años más se establecieron con un local en General Paz 576 que
              permanece hasta el día de hoy siendo la veterinaria más
              reconocidas de Tucumán. Luego agregaron el servicio de venta de
              accesorios, en una que conseguían de la industria local. Ya
              consolidado como uno de los locales más completos en accesorios y

    ...
    <MDBContainer >
      ...
      <MDBTypography variant="h2"className="titulos" >
        ...
        <MDBTypography >
            ...
            permanece hasta el día de hoy siendo la veterinaria más reconocidas de Tucumán.
       
            Luego agregaron el servicio de venta de accesorios, en una que
            conseguían de la industria local.
           ...
           <img src="https://www.cursosycarreras.com.mx/orientacion/wp-content/uploads/2019/05/bigstock-Doctor-Veterinarian-At-Clinic-214964890-1-e1557320391714.jpg" className=" img-fluid" alt="" />
           </div>
        </MDBCol>
        <MDBCol className="contenido3 d-flex">
          <div className="imagenespatitas">
          <img  src="https://thumbs.dreamstime.com/b/perro-de-examen-del-veterinario-con-el-otoscopio-38865424.jpg" className="imagenfondo3 img-fluid" alt="" />
          </div>

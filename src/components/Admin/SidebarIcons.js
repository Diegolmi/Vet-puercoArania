    ...
    return ( 
        <div className="sidebaricons-container">
            ...
            <ul className="secciones-sidebar">
                <li className="listado-sidebar"> <Link to="/privado/admin"  className="link-sidebar"><MdDashboard className="icon-sidebar-admin"/></Link></li>
                <li className="listado-sidebar"> <Link to="/privado/admin/user"  className="link-sidebar"><FaUser className="icon-sidebar-admin"/></Link></li>

      ...
      <MDBContainer fluid  className=" text-center text-md-left">
        <MDBRow  >
          ...
          <MDBCol  lg="2"   >
            ...
            <h5 id="texto" className="text-uppercase mb-4 font-weight-bold">CONTACTÁNOS:</h5>
          ...
          <MDBCol md="5" lg="20" className="text-center">
            <div className="contacto">
             ...
             <div className="ubicacion d-flex flex-column">
              <h5 id="texto" className="text-uppercase mb-4 font-weight-bold">   Encontranos en:   </h5>

        ...
        <section className="my-5">
          ...
          <MDBRow>
            <MDBCol md="4">
              ...
              <MDBRow className="mb-3">
                <MDBCol size="2">
                  <MDBIcon icon="vial" size="2x" className="deep-purple-text" />
                </MDBCol>
                <MDBCol size="10">
                  <h5 className="font-weight-bold mb-3">Análisis clínicos</h5>
                  <p className="grey-text" id="holi">
                    Contamos con equipamiento para hacer analíticas in situ. De
                    esta manera se aceleran los procedimientos y podemos emitir
                    un diagnóstico e implementar el tratamiento adecuado de
            ...
            <MDBCol md="4">
              <MDBRow className="mb-3">
                <MDBCol size="2">
                  <MDBIcon icon="spa" size="2x" className="deep-purple-text" />
                </MDBCol>
                <MDBCol size="10">
                  <h5 className="font-weight-bold mb-3">Estética y spa</h5>
                  <p className="grey-text" id="holi">
                    Les cortamos el pelo con tijera, se cortan las uñas, limpian
                    los oídos y vacían los sacos anales. Ambientamos con música
                    a 432 hz para procurar que tu mascota se relaje y sienta a
                    gusto.
                  </p>
                </MDBCol>
              </MDBRow>
              <MDBRow className="mb-3">
                <MDBCol size="2">
                  <MDBIcon icon="home" size="2x" className="deep-purple-text" />
                </MDBCol>
                <MDBCol size="10">
              ...
              <MDBRow className="mb-3">
                ...
                <MDBCol size="10">
                  ...
                  <p className="grey-text" id="holi">
                    ...
                    tejidos blandos como de huesos y articulaciones, por lo que
                    es una herramienta de inestimable utilidad. La técnica

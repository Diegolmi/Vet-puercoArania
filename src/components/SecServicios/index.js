...
return ( 
    ...
    <div className="cont_ppal">
        ...
        <div className="tooltip-front">Necesitas estar logueado para acceder a esta opcion</div>
      </MDBTooltip>
        </p>
        ...
        <MDBRow>
          <MDBCol md="4">
            ...
            <MDBRow className="mb-3">
              <MDBCol size="2">
                <MDBIcon icon="heartbeat" size="2x" className="deep-purple-text" />
              </MDBCol>
              <MDBCol size="10">
          ...
          <MDBCol md="4">
            ...
            <MDBRow className="mb-3">
              <MDBCol size="2">
                <MDBIcon icon="x-ray" size="2x" className="deep-purple-text" />
              </MDBCol>
              <MDBCol size="10">
